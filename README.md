...
- **Real Activity Log** — the Home tab's activity feed now shows real install/remove/upgrade/reinstall history (`ActivityLogManager`, persisted to `/var/jb/var/cytroll/activity.json`) instead of placeholder rows.
